...
import util.debug.ShapeRendererUtils;
...
public class GameRenderer implements Disposable {
    ...
    private void drawGamePlay() {
        ...
        // pickups
        Array<PowerUp> pickups = controller.getPickups();
    ...
    private void drawHud() {
        ...
        String liveString = "LIVES: " + controller.getLives();
        layout.setText(scoreFont, liveString);
        scoreFont.draw(batch, layout, GameConfig.HUD_WIDTH - layout.width, GameConfig.HUD_HEIGHT - layout.height);
    }

    private TextureRegion findPickupRegion(PowerUp pickup) {
